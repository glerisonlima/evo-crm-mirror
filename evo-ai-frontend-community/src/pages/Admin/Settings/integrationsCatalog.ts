...
export const INTEGRATIONS: IntegrationDef[] = [
  ...
  { key: 'google_calendar', configType: 'google_calendar', clientIdKey: 'GOOGLE_CALENDAR_CLIENT_ID', clientSecretKey: 'GOOGLE_CALENDAR_CLIENT_SECRET', callbackPath: '/google-calendar/callback' },
  { key: 'google_sheets', configType: 'google_sheets', clientIdKey: 'GOOGLE_SHEETS_CLIENT_ID', clientSecretKey: 'GOOGLE_SHEETS_CLIENT_SECRET', callbackPath: '/google-sheets/callback' },
