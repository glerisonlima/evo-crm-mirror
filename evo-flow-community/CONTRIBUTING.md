# Contributing to Evo Flow

Thanks for your interest in contributing to Evo Flow! This document
...
1. Check existing [issues](https://github.com/evolution-foundation/evo-flow/issues)
   to avoid duplicates
...
Thanks for helping make Evo Flow better!
