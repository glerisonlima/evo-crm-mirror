# Evo Flow — Trademark and Brand Assets Policy

Version 1.0, 2026.05.06

"Evolution Foundation", "Evolution" and "Evo Flow" are trademarks of
Evolution Foundation. The "evoflow" wordmark and the Evo Flow
logo are trademarks of Evolution Foundation.

## 1. Scope and purpose

This policy governs the use of Evo Flow trademarks and brand assets.
It is intended to protect users from confusion and to preserve the official
Evo Flow visual identity.

This policy applies to any use of:
(a) the product names and marks "Evolution Foundation", "Evolution" and "Evo Flow";
(b) the official logo and wordmark: the "evoflow" wordmark and any
    associated icon in neon green;
(c) the copyright line "© 2026 Evolution Foundation"; and
(d) any materials that implement or express the Evo Flow official look
...
2.1. You may truthfully refer to Evo Flow to describe that your software
...
Evo Flow that include Evo Flow brand assets, provided that you
comply with Section 3 and do not suggest endorsement beyond being an official
unmodified build.

2.3. You may use Evo Flow marks in nominative ways, such as
"based on Evo Flow", provided that the use is accurate and does not
create confusion.

## 3. Protected Visual Identity Elements (Brand Assets)

The following are the "Protected Visual Identity Elements":
(a) Product names and marks: "Evolution Foundation", "Evolution" and "Evo Flow";
(b) Official logo and wordmark: the "evoflow" wordmark and any associated icon;
...
Evo Flow brand assets.** If you distribute or publicly host any version
of the user interface that uses Evo Flow brand assets, you may not
remove, replace, modify, disable, or bypass any Protected Visual Identity Element.

4.2. **Modified UI must remove Evo Flow brand assets.**
...
(a) remove and replace all Evo Flow trademarks and brand assets from
    the user interface, product name display, and related marketing materials
    for that distribution; and
(b) choose a name and branding that are clearly distinct from Evo Flow.

4.3. **No endorsement.**
You may not use Evo Flow trademarks or brand assets in a way that
...
Any violation of this policy terminates your permission to use Evo Flow
brand assets. You must promptly cease use and remove Evo Flow trademarks
